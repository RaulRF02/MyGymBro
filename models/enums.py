...
DifficultyLevelEnum = Enum('beginner', 'intermediate', 'advanced', name='difficulty_levels')
...
ExerciseTypeEnum = Enum('strength', 'cardio', 'mobility', 'flexibility', name='exercise_type')
