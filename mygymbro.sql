...
INSERT INTO users VALUES(3,'carlos','carlos','13574687E','carlos','scrypt:32768:8:1$RW326AkDv7dJSPA1$eb3ecb13e3f0a307e8e495351a2f6ea5372d7ffe6ea0dca1216f166c40040bafc72893404386617c67e906a2188dbfc7f5e2a1137499002000baa5f5802b5394','user',NULL,NULL,NULL,NULL,NULL,0);
INSERT INTO users VALUES(4,'admin','admin','admin','admin','scrypt:32768:8:1$MJ1meou84wfuLw0q$325a61a38b28a6a0022fa603182ce17425748b9b5fe23b1e38dbaaa550d2a3fb917c4c3d1561042cff61f4ef06aa3337e5bcb8a9864c76a2dbec08d9060f0a4f','user',NULL,NULL,NULL,NULL,NULL,0);
...
INSERT INTO exercises VALUES(3,'Pull-Ups','Builds overall back strength and muscle definition.','strength','repetitions',10,1,0,'Pull-up Bar',3,0.0,120,NULL,'Focus on pulling with your back, not your arms.');
INSERT INTO exercises VALUES(4,'Standing Forward Bend','Stretches the hamstrings and improves flexibility.','mobility','time',60,0,0,'None',2,0.0,30,NULL,'Bend at the hips and keep your legs straight.');
INSERT INTO exercises VALUES(5,'Bodyweight Squats','Targets the quadriceps and glutes for lower body strength.','strength','repetitions',15,0,0,'None',4,0.0,60,NULL,'Keep your knees aligned with your toes.');
INSERT INTO exercises VALUES(6,'Dumbbell Shoulder Press','Engages the shoulders and core.','strength','repetitions',8,1,0,'Dumbbells',4,0.0,90,NULL,'Maintain a straight back while lifting.');
INSERT INTO exercises VALUES(7,'Running','Increases heart rate and burns calories.','cardio','time',600,0,0,'None',1,0.0,0,NULL,'Maintain a steady pace and focus on breathing.');
INSERT INTO exercises VALUES(8,'Bicep Curls','Strengthens the biceps and forearms.','strength','repetitions',12,1,0,'Dumbbells',3,0.0,60,NULL,'Keep your elbows close to your sides.');
INSERT INTO exercises VALUES(9,'Crunches','Targets the core muscles.','strength','repetitions',15,0,0,'None',3,0.0,30,NULL,'Keep your core tight and do not strain your neck.');
INSERT INTO exercises VALUES(10,'Lunging Hip Flexor Stretch','Stretches the hip flexors and lower back.','flexibility','time',45,0,0,'None',2,0.0,20,NULL,'Hold the stretch and breathe deeply.');
INSERT INTO exercises VALUES(11,'Kettlebell Swings','Strengthens the core and lower back.','strength','repetitions',10,1,0,'Kettlebell',4,0.0,90,NULL,'Swing the kettlebell with your hips, not your arms.');
INSERT INTO exercises VALUES(12,'Shoulder Dislocates','Improves shoulder and upper back mobility.','mobility','time',60,0,0,'None',3,0.0,30,NULL,'Focus on controlled movements.');
INSERT INTO exercises VALUES(13,'Deadlift','Builds leg strength and stability.','strength','repetitions',12,1,0,'Barbell',4,0.0,120,NULL,'Keep your back straight while lifting.');
INSERT INTO exercises VALUES(14,'Burpees','Burns calories and strengthens the legs.','cardio','time',300,0,0,'None',3,0.0,60,NULL,'Maintain a quick pace and steady rhythm.');
INSERT INTO exercises VALUES(15,'Dips','Targets triceps and shoulders.','strength','repetitions',12,1,0,'Parallel Bars',3,0.0,90,NULL,'Lower yourself slowly to avoid injury.');
INSERT INTO exercises VALUES(16,'Chest Stretch','Stretches the chest and shoulders.','flexibility','time',60,0,0,'None',2,0.0,20,NULL,'Hold the stretch without bouncing.');
...
INSERT INTO training_plans VALUES(2,'Muscle Gain Program','A 12-week plan focused on building muscle.','muscle_gain',12,5,'intermediate',NULL,NULL,2,1,'2024-11-20','2025-02-20','active','Focus on compound exercises for maximum results.');
...
CREATE TABLE _alembic_tmp_progress_records (
	id INTEGER NOT NULL, 
	record_date DATE, 
	exercise_id INTEGER NOT NULL, 
	routine_id INTEGER NOT NULL, 
